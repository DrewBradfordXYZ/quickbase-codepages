...
function generateHtml() {
    ...
    const quickbasePagesUrl = process.env.QUICKBASE_CODEPAGES_URL || "<-QUICKBASE-CODEPAGES-URL->";
...
<body>
  ...
  ${jsScripts}
    ...
    findUp(".git", { type: "directory" }).then((gitRootPath) => {
        ...
        // Writing to file
        fs.writeFileSync(path.join(process.cwd(), `./dist/${rootFolderName}.html`), htmlContent, "utf8");
    });
}
generateHtml();
