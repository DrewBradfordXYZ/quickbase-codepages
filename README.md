...
Automatically update your QuickBase code pages with `./dist` files using `npm run codepages`. It also generates an HTML file with JS and CSS code page links with `npm run build`.
